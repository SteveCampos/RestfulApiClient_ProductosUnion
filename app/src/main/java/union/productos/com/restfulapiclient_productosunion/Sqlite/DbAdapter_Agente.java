...
public class DbAdapter_Agente {
    ...
    public long createAgente(LiquidacionAgente agente) {

        ContentValues initialValues = new ContentValues();
        initialValues.put(AG_id_agente_venta,agente.getIdAgente());
        ...
        initialValues.put(AG_nom_usuario,agente.getNomUsuario());
        initialValues.put(AG_pass_usuario,agente.getPassUsuario());
        initialValues.put(AG_liquidacion,agente.getIdLiquidacion());
        initialValues.put(AG_km_inicial,agente.getKmInicial());
        initialValues.put(AG_km_final,agente.getKmFinal());
        initialValues.put(AG_nombre_ruta,agente.getRuta());
        ...
        initialValues.put(AG_serie_rrpp,"");
        ...
        initialValues.put(AG_correlativo_rrpp, "");

        return mDb.insert(SQLITE_TABLE_Agente, null, initialValues);
    }

    public void updateAgente(LiquidacionAgente agente){
        ...
        mDb.update(SQLITE_TABLE_Agente, initialValues,
                AG_id_agente_venta+"=?",new String[]{""+agente.getIdAgente()});
    }
