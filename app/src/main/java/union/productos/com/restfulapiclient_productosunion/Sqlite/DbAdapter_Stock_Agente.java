...
public class DbAdapter_Stock_Agente {
    ...
    public long createStockAgentes(StockAgente stockAgente, int idAgente, int sincronizado){
        ...
        initialValues.put(ST_codigo,stockAgente.getProVCodigo());
        ...
        initialValues.put(ST_disponible,stockAgente.getStockDisponible());
        initialValues.put(ST_ventas,0);
        initialValues.put(ST_canjes,0);
        initialValues.put(ST_devoluciones,0);
        initialValues.put(ST_buenos,0);
        initialValues.put(ST_malos,0);
        initialValues.put(ST_fisico,0);
